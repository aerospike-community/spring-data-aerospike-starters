 ...
 */
public class AerospikeReactiveDataAutoConfigurationTests {
    private ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(AerospikeReactiveDataAutoConfiguration.class, MockConfiguration.class));
    ...
    static class MockConfiguration {
        ...
        public ReactiveAerospikeTemplate reactiveAerospikeTemplate() {
            return Mockito.mock(ReactiveAerospikeTemplate.class);
        }
